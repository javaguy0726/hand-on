...
public class TheUserServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (url.equals("/Login")) {//登录处理
			...
			}else if(url.equals("/ValidaValidation")){//验证验证码
				String validation = (String)session.getAttribute("RANDOMVALIDATECODEKEY");
				String validationServlet = request.getParameter("getValida");
