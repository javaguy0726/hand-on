...
function refresh(obj) {
	...
	//創建Ajax請求對象。
		...
		function clickSub(){
			var c = document.getElementById( "prompt" ).innerHTML;
			var str = document.getElementById("username").value;
			var passWord2 = document.getElementById("cfPassword").value;
			var passWord = document.getElementById("passWord").value;
			var age = document.getElementById("age").value;
			...
			var getVali =document.getElementById("PutvalidaCode").value;
			var scendVali =document.getElementById("OutvalidaCode").value;
			if(str.length==0){
				document.getElementById("prompt").innerHTML="<font style='color: red'>Username can not be empty!</font>";
			return false;
			}
	...
	<form action="AddUser.do" method="post">
		<table>
			...
			<tr>
        		...
        		<td><input type="text" name="randomCode"/><img title="点击更换" onclick="javascript:refresh(this);" src="imageServlet"></td>
			</tr>
